...
`),
	...
	cmd.Flags().StringVar(&kubeServer, "dest-kube-server", "", "The default destination kubernetes server for applications in this project")
	...
	cmd.Flags().StringToStringVar(&labels, "labels", nil, "Optional labels that wil lbe set on the Application resource. (e.g. \"app.kubernetes.io/managed-by={{ placeholder }}\"")
