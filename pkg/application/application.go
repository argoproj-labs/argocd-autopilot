...
func AddFlags(cmd *cobra.Command) *CreateOptions {
	...
	cmd.Flags().StringVar(&opts.Include, "include", "", "glob to specify include files, e.g: _____")
	cmd.Flags().StringVar(&opts.Include, "exclude", "", "glob to specify exclude files, e.g: _____")
