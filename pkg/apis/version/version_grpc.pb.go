...
func (c *versionClient) Version(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*VersionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/github.com.argoproj.argocd_autopilot.pkg.apis.version.Version/Version", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Version_Version_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.argoproj.argocd_autopilot.pkg.apis.version.Version/Version",
	}
...
var Version_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.argoproj.argocd_autopilot.pkg.apis.version.Version",
	...
	Metadata: "pkg/apis/version/version.proto",
}
